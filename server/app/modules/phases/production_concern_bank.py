...
_SOURCE_BY_SLUG = {
    "identity-documents": (
        "Passport and travel document advice",
        "https://www.gov.uk/government/organisations/hm-passport-office",
        "Origin and destination authorities",
    ),
    "entry-permission": (
        "Check UK visa",
        "https://www.gov.uk/check-uk-visa",
        "Destination immigration authority",
    ),
    "residence-permit": (
    ...
    "document-copies": (
        ...
        "https://www.gov.uk/government/publications/keeping-your-passport-safe",
        "Origin and destination authorities",
    ),
    "official-translations": (
        "UK visa supporting documents",
        "https://www.gov.uk/government/publications/translated-documents",
        "Destination immigration authority",
    ),
    "departure-notice": (
        "Living abroad",
        "https://www.gov.uk/guidance/living-in-a-country-or-territory",
    ...
    "pet-import": (
        "Pet travel: approved routes and requirements",
        "https://www.gov.uk/bring-pet-to-great-britain",
        "Destination animal-health authority",
    ),
    "shipping-inventory": (
        "Moving abroad",
        "https://www.gov.uk/guidance/moving-or-retiring-abroad",
        "Origin and destination authorities",
    ),
    "temporary-housing": (
        "Moving abroad: accommodation",
        "https://www.gov.uk/guidance/moving-or-retiring-abroad",
    ...
    "permanent-housing": (
        ...
        "Destination housing jurisdiction",
    ),
    "lease-review": (
        "Renting privately",
        "https://www.gov.uk/private-renting",
    ...
    "banking": (
        "Financial Conduct Authority: banking",
        "https://www.fca.org.uk/consumers/bank-accounts",
        "Destination financial regulator",
    ),
    "payments": (
        "Protect yourself from scams",
        "https://www.gov.uk/stop-scams",
        "Destination jurisdiction",
    ),
    "tax-residency": (
        "International individuals and businesses",
        "https://www.gov.uk/government/organisations/hm-revenue-customs",
        "Origin and destination tax authorities",
    ),
    "tax-filing": (
    ...
    "insurance": (
        ...
        "https://www.who.int/health-topics/travel-health",
        "Destination health jurisdiction",
    ),
    ...
    "medication": (
        ...
        "https://www.gov.uk/travelling-with-medicine",
        "Destination medicines authority",
    ),
    "vaccinations": (
        "WHO travel vaccines",
    ...
    "schooling": (
        ...
        "Destination education jurisdiction",
    ),
    "child-documents": (
    ...
    "employment-contract": (
        ...
        "Destination employment jurisdiction",
    ),
    "professional-licensing": (
        "Regulated professions",
        "https://www.gov.uk/government/collections/recognition-of-professional-qualifications",
        "Destination licensing authority",
    ),
    "social-security": (
    ...
    "driving-license": (
        ...
        "Destination transport authority",
    ),
    "mobile-connectivity": (
        "Moving abroad",
        "https://www.gov.uk/guidance/moving-or-retiring-abroad",
    ...
    "data-roaming": (
        ...
        "https://www.gov.uk/guidance/using-your-mobile-abroad",
        "Origin and destination telecom authorities",
    ),
    "safety-plan": (
        "Foreign travel advice",
        "https://www.gov.uk/foreign-travel-advice",
        "Destination safety jurisdiction",
    ),
    "consular-support": (
        "Support for British nationals abroad",
        "https://www.gov.uk/foreign-travel-advice",
        "Origin consular authority",
    ),
    "community-support": (
        "Newcomer services",
        "https://www.canada.ca/en/immigration-refugees-citizenship/services/newcomers.html",
    ...
    "money-transfer": (
        ...
        "https://www.fca.org.uk/consumers/payment-services",
        "Destination financial regulator",
    ),
    "records-retention": (
        "Keep your passport safe",
...
_TOPICS = [
    ...
    (
        "official-translations",
        "Check whether certified translations are required",
        75,
        0,
        "Documents",
    ),
    (
        "departure-notice",
        "Record departure and address-change obligations",
        70,
        0,
        "Administration",
    ),
    ...
    (
        "records-retention",
        "Store records for future applications and renewals",
        55,
        90,
        "Documents",
    ),
    (
        "renewal-calendar",
        "Create a calendar for permits and document renewals",
        70,
        90,
        "Administration",
    ),
